...
![Above-the-fold view of the Vertex AI Agent Builder signed-out page](screenshots/google-vertex-ai-agent-builder-signed-out-page-trust-architecture/above-the-fold.png)
...
![Full-page view of the Vertex AI Agent Builder signed-out page](screenshots/google-vertex-ai-agent-builder-signed-out-page-trust-architecture/full-page.png)
